export default function PrivacyPolicyPage() {
  return (
    <div style={{ fontFamily: 'sans-serif', padding: '20px', lineHeight: '1.6' }}>
      ...
      <ul>
        <li><strong>Personal Information Provided by You:</strong> We collect names; email addresses; phone numbers; mailing addresses; usernames; passwords; contact preferences; contact or authentication data; billing addresses; debit/credit card numbers; and other similar information.</li>
      ...
      <h2>9. Contact Us</h2>
      <p>
        If you have questions or comments about this policy, you may email us at admin@kollaborate.co or by post to:
      </p>
      <p>
        Innatus<br />
